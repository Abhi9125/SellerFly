...
//                 className={`${
//                   isScrolled ? "text-black" : "text-black"
//                 } hover:text-red-600 font-medium transition duration-300`}
//               >
//                 HOME
//               </Link>
//             </li>
...
//                 className={`${
//                   isScrolled ? "text-black" : "text-black"
//                 } hover:text-red-600 font-medium transition duration-300 sm:inline`}
//               >
//                 SERVICES
//               </button>
...
//         <button
//           onClick={openModal}
//           className="hidden sm:block bg-yellow-600 hover:bg-yellow-700 text-white py-2 px-6 rounded-lg font-medium transition duration-300"
//         >
  ...
  return (
    ...
    >
      <div className="container mx-auto flex justify-between items-center px-4 sm:px-6 lg:px-6 py-3">
        ...
        <button
          onClick={openModal}
          className="hidden sm:block bg-red-600 hover:bg-yellow-700 text-white py-2 px-6 rounded-lg font-medium transition duration-300"
        >
          GET FREE CONSULTATION!!
        </button>
        {isModalOpen && <ModalComponent closeModal={closeModal} />}
