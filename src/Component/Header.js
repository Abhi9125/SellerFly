...
//   return (
//     <header className="fixed top-0 left-0 w-full z-50 bg-white shadow-lg transition-all duration-300 text-black">
...
//         <button
//           onClick={toggleMenu}
//           className="text-3xl sm:hidden focus:outline-none relative z-50 text-black"
