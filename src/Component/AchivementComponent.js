...
//         onExit={() => setCounterState(false)}
//       >
//         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 text-center gap-8">
//           {/* Counter 1 */}
//           <div className="flex flex-col items-center justify-center p-4 text-white transform transition duration-500 hover:scale-105">
//             <FaUsers className="text-6xl mb-4 text-red-600 animate-bounce" />
...
//               +
//             </h2>
//             <p className="font-semibold text-white mt-2">Ecommerce Clients</p>
//           </div>

//           {/* Counter 2 */}
//           <div className="flex flex-col items-center justify-center p-4 text-white transform transition duration-500 hover:scale-105">
//             <FaStar className="text-6xl mb-4 text-red-600 animate-bounce" />
//             <h2 className="text-5xl font-bold">
//               {counterState && (
//                 <CountUp
//                   start={0}
...
//               +
//             </h2>
//             <p className="font-semibold text-white mt-2">Websites Developed</p>
//           </div>

//           {/* Counter 3 */}
//           <div className="flex flex-col items-center justify-center p-4 text-white transform transition duration-500 hover:scale-105">
//             <FaCoffee className="text-6xl mb-4 text-red-600 animate-bounce" />
//             <h2 className="text-5xl font-bold">
//               {counterState && (
//                 <CountUp
//                   start={0}
...
//               + Crore
//             </h2>
//             <p className="font-semibold text-white mt-2">Revenue Generated</p>
//           </div>

//           {/* Counter 4 */}
//           <div className="flex flex-col items-center justify-center p-4 text-white transform transition duration-500 hover:scale-105">
//             <FaChartBar className="text-6xl mb-4 text-red-600 animate-bounce" />
//             <h2 className="text-5xl font-bold">
//               {counterState && (
//                 <CountUp
//                   start={0}
...
//               +
//             </h2>
//             <p className="font-semibold text-white mt-2">Years in Industry</p>
//           </div>
//         </div>
//       </ScrollTrigger>
//     </section>
